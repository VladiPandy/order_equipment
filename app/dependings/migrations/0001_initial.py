    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analazy_n', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analyze_2', to='basic_elements.analyze', verbose_name='Анализ_2')),
                ('project_n', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_2', to='basic_elements.project', verbose_name='Проект_2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analazy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analyze_1', to='basic_elements.analyze', verbose_name='Анализ_1')),
