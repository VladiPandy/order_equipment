    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_nick', models.CharField(blank=True, max_length=255, null=True, verbose_name='Ник в телеграмме')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_request_limit', models.IntegerField(default=2, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Предел заявок в день')),
            ],
            options={
                'verbose_name': 'Прибор',
